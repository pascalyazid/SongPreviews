    ...
    <div id="banner" class="sticky-top bg-light py-3 mb-4" style="z-index: 999;">
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="d-flex shadow-sm rounded-pill overflow-hidden bg-white">
                    <input class="form-control border-0 shadow-none px-4 py-3" type="text" placeholder="Search for a song or an artist..." name="artist" autofocus required>
